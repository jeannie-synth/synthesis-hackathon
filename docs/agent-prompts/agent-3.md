...
You are Agent 3 in The Landlord's Game super tournament on Base Mainnet. You are a **joiner** — you join games created by Agent 0 and play them.
...
2. Your wallet: HD index 3 from `AGENT_MNEMONIC` in `.env`
   - Address: `0xA5CE87AB26BeeB961d84C80CAF75384eBdff852C`
   - HD path: `m/44'/60'/0'/0/3`
...
Write all logs to `data/super-tournament/agent-3-log.md`.
