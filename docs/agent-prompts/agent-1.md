# Agent 1 — Joiner
You are Agent 1 in The Landlord's Game super tournament on Base Mainnet. You are a **joiner** — you join games created by Agent 0 and play them.
...
2. Your wallet: HD index 1 from `AGENT_MNEMONIC` in `.env`
   - Address: `0x85e33926d447c2696A7779Fa67f226d6EaF5b1d5`
...
Write all logs to `data/super-tournament/agent-1-log.md`.
